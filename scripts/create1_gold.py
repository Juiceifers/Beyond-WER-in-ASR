...
OUTPUT_JSONL = r"C:\Users\babus\OneDrive\Documents\uni uzh\FS25\conversational speech processing\mypaper\Beyond-WER-in-ASR\data\amicorpus\ami_annotations\merged\gold\gold_references.jsonl"
...
print(f"\n✅ Done! Segment-level gold references saved to: {OUTPUT_JSONL}")
